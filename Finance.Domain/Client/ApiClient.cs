...
[assembly: System.Runtime.CompilerServices.InternalsVisibleToAttribute("Finance.Domain.Test")]
namespace Finance.Domain.Client
{
    /// <summary>
    ...
    internal class CustomJsonCodec : RestSharp.Serializers.ISerializer, RestSharp.Deserializers.IDeserializer
    {
        ...
        public string Serialize(object obj)
        {
            ...
            if (obj.GetType().FullName.Contains(@"Finance.Domain.Model.Accounting") || obj.GetType().FullName.Contains(@"Finance.Domain.Model.PayrollAu") )
            {
    ...
    public partial class ApiClient : ISynchronousClient, IAsynchronousClient
    {
        ...
        public ApiClient()
        {
            _baseUrl = Finance.Domain.Client.GlobalConfiguration.Instance.BasePath;
        }
